...
static unsigned char * fc_file_contents_1_array;
static unsigned char * fc_file_contents_1 (void) {
  unsigned long sz;
  fc_file_contents_1_array = tis_inject_file ("Test/array.b", &sz);
